...
?? Dependencias:
    sudo apt update
    sudo apt install python3-pip python3-dev libopenjp2-7 libtiff5
    pip3 install python-osc luma.oled spidev RPi.GPIO gpiozero

    EN VD PARECE QUE sudo apt install python3-pip python3-dev libopenjp2-7 libtiff6
